...
function createAbstractElement(data, jqueryEle) {
    ...
    // Gave attribute of centering the text, spaceing with a message body, and text it blue
    emailInput.attr('class', 'data-output has-text-centered message-body has-text-link');
    ...
    deliverabilityOutput.attr('class', 'data-output has-text-centered message-body has-text-link');
    ...
    qualityScoreOutput.attr('class', 'data-output has-text-centered message-body has-text-link');
    ...
    isFreeEmail.attr('class', 'data-output has-text-centered message-body has-text-link');
    ...
    isDisposableEmail.attr('class', 'data-output has-text-centered message-body has-text-link');
    ...
    isRoleEmail.attr('class', 'data-output has-text-centered message-body has-text-link');
    ...
    isCatchallEmail.attr('class', 'data-output has-text-centered message-body has-text-link');
    ...
    isSmtpValid.attr('class', 'data-output has-text-centered message-body has-text-link');

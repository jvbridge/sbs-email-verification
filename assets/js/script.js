...
function createAbstractElement(data, jqueryEle) {
    ...
    emailInput.attr('class', 'data-output has-text-centered card card-content has-text-link-dark m-3');
    ...
    deliverabilityOutput.attr('class', 'data-output has-text-centered card card-content has-text-link-dark m-3');
    ...
    qualityScoreOutput.attr('class', 'data-output has-text-centered card card-content has-text-link-dark m-3');
    ...
    isFreeEmail.attr('class', 'data-output has-text-centered card card-content has-text-link-dark m-3');
    ...
    isDisposableEmail.attr('class', 'data-output has-text-centered card card-content has-text-link-dark m-3');
    ...
    isRoleEmail.attr('class', 'data-output has-text-centered card card-content has-text-link-dark m-3');
    ...
    isCatchallEmail.attr('class', 'data-output has-text-centered card card-content has-text-link-dark m-3');
    ...
    isSmtpValid.attr('class', 'data-output has-text-centered card card-content has-text-link-dark m-3');

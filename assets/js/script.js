...
function createAbstractElement(data, jqueryEle) {
    ...
    deliverabilityOutput.attr('class', 'data-output has-text-centered message-body has-text-link-dark');
    ...
    qualityScoreOutput.attr('class', 'data-output has-text-centered message-body has-text-link-dark');
    ...
    isFreeEmail.attr('class', 'data-output has-text-centered message-body has-text-link-dark');
    ...
    isDisposableEmail.attr('class', 'data-output has-text-centered message-body has-text-link-dark');
    ...
    isRoleEmail.attr('class', 'data-output has-text-centered message-body has-text-link-dark');
    ...
    isCatchallEmail.attr('class', 'data-output has-text-centered message-body has-text-link-dark');
    ...
    isSmtpValid.attr('class', 'data-output has-text-centered message-body has-text-link-dark');
